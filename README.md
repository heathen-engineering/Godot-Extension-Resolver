...
>
> **The active copy now lives at [codeberg.org/Heathen-Engineering/Godot-Extension-Resolver](https://codeberg.org/Heathen-Engineering/Godot-Extension-Resolver)** — please point your git remote, UPM manifest, or Gem reference there going forward. That's where new commits, releases, and issues actually happen now.
>
